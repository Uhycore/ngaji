            ...
            <div class="flex-1 p-4 md:p-10">
                <div class="container mx-auto">
                    ...
                    <div class="flex flex-col md:flex-row justify-between items-center mb-6 space-y-4 md:space-y-0">
                        <h1 class="text-xl md:text-2xl font-semibold text-gray-700">Admin Management</h1>
                                ...
                                <?php if (!empty($admins)) {
                                    foreach ($admins as $index => $admin) { ?>
                                        <tr class="border-t border-b transition-all duration-300 ease-in-out <?php echo $index % 2 == 1 ? 'bg-gray-200' : ''; ?>">
                                            <td class="py-2 px-3 text-center"><?php echo htmlspecialchars($admin['adminId']); ?></td>
                                            <td class="py-2 px-3 text-center"><?php echo htmlspecialchars($admin['username']); ?></td>
                                            <td class="py-2 px-3 text-center"><?php echo htmlspecialchars($admin['password']); ?></td>
                                            <td class="py-2 px-3 text-center"><?php echo htmlspecialchars($admin['roleId']['roleNama']); ?></td>
                                            <td class="py-2 px-3 text-center"><?php echo htmlspecialchars($admin['adminJenisKelamin']); ?></td>
                                            <td class="py-2 px-3 text-center"><?php echo htmlspecialchars($admin['adminAlamat']); ?></td>
                                            <td class="py-2 px-3 text-center"><?php echo htmlspecialchars($admin['adminNoTelp']); ?></td>
