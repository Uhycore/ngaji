    ...
    <div class="grid md:grid-cols-8 grid-cols-1 min-h-screen">
        ...
        <div class="p-6 flex flex-col items-start md:hidden space-y-4">
            <div class="flex flex-col items-start">
                ...
                <h1 class="text-3xl font-semibold text-gray-800">
                    <?php echo htmlspecialchars($bendahara['username']); ?>
                </h1>
            </div>
        </div>
        ...
        <main class="col-span-7 h-full flex flex-col">
            <div class="bg-gradient-to-r from-green-300 to-green-400 p-6">
                <p class="text-3xl font-semibold text-white">Profil bendahara</p>
            </div>
            ...
            <section class="bg-gray-50 p-6 flex-grow space-y-6">
                ...
                <div class="bg-gradient-to-r from-green-400 to-green-500 p-4 rounded-lg shadow-md mb-6">
                    <h1 class="text-3xl font-semibold text-white">Data bendahara</h1>
                </div>
                ...
                <div class="grid grid-cols-7 gap-4 p-4 border border-gray-200 rounded-lg shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <div class="text-left pl-4 col-span-5">
                        <span class="text-gray-800"><?php echo htmlspecialchars($bendahara['bendaharaJenisKelamin']); ?></span>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-7 gap-4 p-4 border border-gray-200 rounded-lg shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <div class="text-left pl-4 col-span-5">
                        <span class="text-gray-800"><?php echo htmlspecialchars($bendahara['bendaharaTempatTglLahir']); ?></span>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-7 gap-4 p-4 border border-gray-200 rounded-lg shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <div class="text-left pl-4 col-span-5">
                        <span class="text-gray-800"><?php echo htmlspecialchars($bendahara['bendaharaAlamat']); ?></span>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-7 gap-4 p-4 border border-gray-200 rounded-lg shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <div class="text-left pl-4 col-span-5">
                        <span class="text-gray-800"><?php echo htmlspecialchars($bendahara['bendaharaNoTelp']); ?></span>
                    </div>
                </div>
            </section>
