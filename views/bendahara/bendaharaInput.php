    ...
    <div class="flex">
        ...
        <div class="flex-1 p-20">
            ...
            <div class="max-w-md mx-auto bg-gradient-to-br from-white to-gray-100 p-8 rounded-2xl shadow-xl">
                <h2 class="text-xl font-bold mb-6 text-gray-800 text-center" style="font-family: 'Poppins', sans-serif;">Input bendahara</h2>
                <form action="index.php?modul=bendahara&fitur=add" method="POST" class="space-y-6">
                    <!-- Username -->
                    <div>
                        <label for="username" class="block text-gray-600 text-sm font-semibold mb-2">Nama bendahara</label>
                        <input type="text" id="username" name="username" class="w-full px-4 py-2 rounded-lg shadow-sm border border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-300 focus:outline-none transition duration-200 hover:shadow-md" placeholder="Masukkan Nama bendahara" required>
                    </div>
