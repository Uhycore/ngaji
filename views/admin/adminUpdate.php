                ...
                <form action="index.php?modul=admin&fitur=update" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <select id="jenisKelamin" name="jenisKelamin" class="shadow border rounded-lg w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-300 ease-in-out hover:shadow-md" required>
                            <option value="Laki-laki" <?php echo (isset($objAdmin->jenisKelamin) && $objAdmin->jenisKelamin == 'Laki-laki') ? 'selected' : ''; ?>>Laki-laki</option>
                            <option value="Perempuan" <?php echo (isset($objAdmin->jenisKelamin) && $objAdmin->jenisKelamin == 'Perempuan') ? 'selected' : ''; ?>>Perempuan</option>
                        </select>
                    </div>
