...
<body class="font-sans text-gray-800">
    ...
    <div class="grid md:grid-cols-8 grid-cols-1 min-h-screen">
        ...
        <div class="p-6 flex flex-col items-start md:hidden space-y-4">
            <div class="flex flex-col items-start">
                <img src="assets/profil.jpg" alt="Profile Photo" class="w-24 h-24 rounded-full mb-4 border-4 border-cyan-500">
        ...
        <aside class="bg-gray-50 col-span-1 h-full sticky top-0  hidden md:flex flex-col items-center border-r border-gray-200">
            <img src="assets/profil.jpg" alt="Profile Photo" class="">
            <div class="bg-gray-200 w-full p-4">
                <h1 class="text-2xl font-bold text-gray-800">
                    <?php echo htmlspecialchars($santri->username); ?>
                </h1>
                <h1 class="text-lg font-semibold text-gray-800">
                    Total Nilai : <?php echo htmlspecialchars($totalNilai); ?>
                </h1>
            </div>
        </aside>
        <!-- Main Content -->
        <main class="col-span-7 h-full flex flex-col">
            <!-- Profile Santri -->
            <div class="bg-gradient-to-r from-green-200 to-green-300">
                <p class="text-2xl font-semibold text-gray-800 p-3">Profil Santri</p>
            </div>

            <section class="bg-white p-6 flex-grow">
                <div class="bg-gradient-to-r from-green-200 to-green-300 p-3 rounded-lg mb-4">
                    <h1 class="text-2xl font-semibold text-gray-800">Data Santri :</h1>
                </div>

                <!-- Jenis Kelamin -->
                <div class="grid grid-cols-7 font-medium text-gray-700 mb-2 p-4 border border-gray-300 rounded-lg shadow-md">
    ...
    <div class="border-t border-gray-200">
        <footer class="text-center text-gray-600 text-sm p-4 border-gray-200 ">
