            ...
            <div class="flex-1 p-4 md:p-10">
                <div class="container mx-auto">
                    ...
                    <div class="flex flex-col md:flex-row justify-between items-center mb-6 space-y-4 md:space-y-0">
                        <h1 class="text-xl md:text-2xl font-semibold text-gray-700">bendahara Management</h1>
                                ...
                                <?php if (!empty($bendaharas)) {
                                    foreach ($bendaharas as $index => $bendahara) { ?>
                                        <tr class="border-t border-b transition-all duration-300 ease-in-out <?php echo $index % 2 == 1 ? 'bg-gray-200' : ''; ?>">
                                            <td class="py-2 px-3 text-center"><?php echo htmlspecialchars($bendahara['bendaharaId']); ?></td>
                                            <td class="py-2 px-3 text-center"><?php echo htmlspecialchars($bendahara['username']); ?></td>
                                            <td class="py-2 px-3 text-center"><?php echo htmlspecialchars($bendahara['password']); ?></td>
                                            <td class="py-2 px-3 text-center"><?php echo htmlspecialchars($bendahara['roleId']['roleNama']); ?></td>
                                            <td class="py-2 px-3 text-center"><?php echo htmlspecialchars($bendahara['bendaharaJenisKelamin']); ?></td>
                                            <td class="py-2 px-3 text-center"><?php echo htmlspecialchars($bendahara['bendaharaAlamat']); ?></td>
                                            <td class="py-2 px-3 text-center"><?php echo htmlspecialchars($bendahara['bendaharaNoTelp']); ?></td>
