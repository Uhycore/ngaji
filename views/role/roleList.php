            ...
            <div class="flex-1 p-4 sm:p-10">
                <div class="container mx-auto">
                    ...
                    <div class="flex flex-col sm:flex-row justify-between items-center mb-6">
                        <h1 class="text-xl sm:text-2xl font-semibold text-gray-700 mb-4 sm:mb-0">Role Management</h1>
                        <a href="index.php?modul=role&fitur=input" class="bg-blue-600 to-indigo-600 hover:from-indigo-600 hover:to-blue-500 text-white font-semibold py-2 px-4 sm:px-6 rounded-lg transition-all duration-300 ease-in-out shadow-lg hover:shadow-2xl transform hover:scale-105">
                            + Insert New Role
                        </a>
                    </div>
