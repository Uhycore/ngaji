...
<body class="bg-gray-100 font-sans">
    ...
    <div class="m-6 max-w-6xl mx-auto rounded-lg mt-10 border border-gray-300 bg-white p-6 shadow-md">
        <h2 class="text-2xl font-semibold text-blue-800 mb-6 border-b border-gray-300 pb-2">Absensi Santri</h2>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full table-auto border-collapse text-gray-700">
                        <thead class="bg-blue-100 text-gray-700 border-b border-gray-300">
                            <tr>
                                <th class="px-1 py-3 text-center border-r border-gray-300">Id Absensi</th>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($absen as $absensi):?>
                                ...
                                <tr class="border-b border-gray-300 hover:bg-gray-50 transition duration-300 <?php echo $isEven ? 'bg-gray-50' : ''; ?>">
                                    <td class="px-1 py-3 text-center border-r border-gray-300"><?php echo htmlspecialchars($absensi->id); ?></td>
                                    <td class="px-6 py-3 border-r border-gray-300"><?php echo htmlspecialchars($absensi->tanggal); ?></td>
                                </tr>
                                <?php $isEven = !$isEven; ?>
                            <?php endforeach; ?>
                        </tbody>
